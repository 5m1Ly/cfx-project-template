...
local function LogClientError(resource, err)
    ...
    formattedString = string.format(formattedString, tmp.time, tmp.ownersrc, tmp.ownername, tmp.identifier, tmp.resource,
        tmp.error)
...
RegisterNetEvent("MG:LogClientError", LogClientError)
